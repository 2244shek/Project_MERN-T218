...
const UpdateEvent = ({ updateEventApi, event, error }) => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="addEvent align-content-center m-5">
      <div id="addEventItems">
        ...
        <div className="mb-4">
          ...
          <input {...register("title")} type="text" placeholder="Project Code" className="form-control" id="title" aria-describedby="title" />
